...
\frame[allowframebreaks]{
    ...
    常用的降维算法有:
    \begin{enumerate}
      \item \textcolor[rgb]{0.00,0.00,1.00}{PCA}:最近重构性、最大可分性,
          \begin{alignat*}{2}
            \arg\min_{W} \quad & -tr(W^TXX^TW)\\
            \mbox{s.t.}\quad
            &W^TW=I
         \end{alignat*}
      ...
      \item \textcolor[rgb]{0.00,0.00,1.00}{FFT，DCT，WT}：主要用于时序数据的分析；
      \item \textcolor[rgb]{0.00,0.00,1.00}{t-SNE}：可视化中用于降维。
    \end{enumerate}
...
\frame{
    ...
    \begin{figure}
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width = 0.8\paperwidth]{figures/rlalgorithm.png}\\
    \end{figure}
}
...
\frame{
	...
	\begin{figure}
		...
		\setlength{\belowcaptionskip}{0.cm}
		\centering
        \subfigure[垃圾邮件过滤]{\includegraphics[width = 0.4\paperwidth]{figures/email.jpg}}
		\subfigure[输入法]{\includegraphics[width = 0.4\paperwidth]{figures/input.jpg}}\\
		\subfigure[机器翻译]{\includegraphics[width = 0.4\paperwidth]{figures/google_tran.jpg}}
		\subfigure[理解未知语言]{\includegraphics[width = 0.4\paperwidth]{figures/arrival.jpg}}
		%\caption{a)Geoffrey Hinton；b)Yoshua Bengio；c)Yann LeCun}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		...
		\setlength{\belowcaptionskip}{0.cm}
		\centering
        \subfigure[智能客服]{\includegraphics[width = 0.3\paperwidth]{figures/kefu.jpg}}
		\subfigure[语音输入法]{\includegraphics[width = 0.3\paperwidth]{figures/yuyinshuru.jpg}}\\
		\subfigure[智能音箱]{\includegraphics[width = 0.25\paperwidth]{figures/yinxiang.jpg}}
		\subfigure[听书]{\includegraphics[width = 0.25\paperwidth]{figures/tingshu.jpg}}
		%\caption{a)Geoffrey Hinton；b)Yoshua Bengio；c)Yann LeCun}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		...
		\setlength{\belowcaptionskip}{0.cm}
		\centering
        \subfigure[人脸识别]{\includegraphics[width = 0.3\paperwidth]{figures/face.png}}
		\subfigure[OCR]{\includegraphics[width = 0.3\paperwidth]{figures/OCR.jpg}}
		\subfigure[车牌识别]{\includegraphics[width = 0.25\paperwidth]{figures/cheliang.jpg}}\\
		\subfigure[步态识别]{\includegraphics[width = 0.25\paperwidth]{figures/butai.jpg}}
        \subfigure[红外温测]{\includegraphics[width = 0.25\paperwidth]{figures/hongwai.jpg}}
		%\caption{a)Geoffrey Hinton；b)Yoshua Bengio；c)Yann LeCun}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		...
		\setlength{\belowcaptionskip}{0.cm}
		\centering
        \subfigure[搜索引擎]{\includegraphics[width = 0.3\paperwidth]{figures/search.jpg}}
		\subfigure[电商]{\includegraphics[width = 0.3\paperwidth]{figures/amzon.jpg}}\\
		\subfigure[新闻推送]{\includegraphics[width = 0.25\paperwidth]{figures/toutiao.jpg}}
		\subfigure[音乐推送]{\includegraphics[width = 0.25\paperwidth]{figures/wangyi.jpg}}
		%\caption{a)Geoffrey Hinton；b)Yoshua Bengio；c)Yann LeCun}
	\end{figure}
}
%\section{\erhao 总结与展望}
...
%  \column{14cm}
\begin{center}
    \textcolor[rgb]{0.98,0.62,0.21}{\tehao 谢谢聆听!}
\end{center}
